...
import { CommentDto, ConversationDto, MessageDto, PaginatedListOfUserDto, UserDto } from "@/lib/api-client";
...
export const SignalRProvider: React.FC<{ children: React.ReactNode }> = ({
  ...
  useEffect(() => {
    const newConnection = new signalR.HubConnectionBuilder()
      .withUrl(`${process.env.EXPO_PUBLIC_BASE_API_URL}/project-hub`, {
