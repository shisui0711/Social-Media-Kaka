...
{
    public class GetFollowingPostWithPaginationQueryValidator : AbstractValidator<GetFollowingPostWithPaginationQuery>
    {
        public GetFollowingPostWithPaginationQueryValidator()
        {
